...
void TreeViewManager::populateShips(FleetTreeItem* shipsRoot)
{
    ...
    for (const ShipData& ship : ships) {
        FleetTreeItem* shipItem = new FleetTreeItem(ship.shipName, FleetTreeItem::Ship, QString::number(ship.shipID), shipsRoot);
...
void FleetTreeViewModel::addShip(const ShipData& ship)
{
    ...
    FleetTreeItem* shipItem = new FleetTreeItem(ship.shipName, FleetTreeItem::Ship, QString::number(ship.shipID), fleetItem);
