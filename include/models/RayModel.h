...
public:
     ...
     */
    virtual double getPathLossDb(const Point2D& pos_tx,
...
public:
    double getPathLossDb(const Point2D& pos_tx,
                         const Point2D& pos_rx,
...
public:
    ...
    static double calculate_distance(const Point2D& pos_tx, const Point2D& pos_rx);
